...
namespace USMB_TECH.Migrations
{
    ...
    [Migration("20260206095451_LinkTypeUtilisationAndTypeClientOnEquipement")]
    partial class LinkTypeUtilisationAndTypeClientOnEquipement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("USMB_TECH.Models.Autoriser", b =>
                {
            ...
            modelBuilder.Entity("USMB_TECH.Models.Equipement", b =>
                {
                    ...
                    b.Property<string>("Url_Modele_3D")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("url_modele_3d");
            ...
            modelBuilder.Entity("USMB_TECH.Models.Proposer", b =>
                {
                    b.Property<int>("Id_Equipement")
                        .HasColumnType("integer")
                        .HasColumnName("id_equipement");

                    b.Property<int>("Id_Type_Utilisation")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("USMB_TECH.Models.Type_Client", b =>
                {
                    ...
                    b.Property<double>("Mult_Tarif_Type_Client")
                        .HasPrecision(2, 2)
                        .HasColumnType("double precision")
                        .HasColumnName("mult_tarif_type_client");

                    b.Property<string>("Nom_Type_Client")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("nom_type_client");
            ...
            modelBuilder.Entity("USMB_TECH.Models.Type_Utilisation", b =>
                {
                    b.Property<int>("Id_Type_Utilisation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("Id_Type_Utilisation"));

                    b.Property<string>("Nom_Type_Utilisation")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("nom_type_utilisation");

                    b.HasKey("Id_Type_Utilisation")
                        .HasName("pk_type_utilisation");

                    b.ToTable("type_utilisation", "usmbTech");
                });
            ...
            modelBuilder.Entity("USMB_TECH.Models.Proposer", b =>
                {
                    ...
                    b.HasOne("USMB_TECH.Models.Type_Utilisation", "Type_UtilisationNavigation")
                        .WithMany("Proposers")
                        .HasForeignKey("Id_Type_Utilisation")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.Navigation("Type_UtilisationNavigation");
                });
