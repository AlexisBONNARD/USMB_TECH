...
articles = descriptionLabo+nomEquipements+descritpionTechEquipement+poleExpertise+nomLabo+poleExpertiseDesc+poleExpertiseNomContenu+poleExpertiseDescContenu+prestationNom+prestationNomCourt+prestationDescription+nom_contact
